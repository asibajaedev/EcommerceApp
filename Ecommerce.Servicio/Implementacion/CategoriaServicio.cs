    ...
    public class CategoriaServicio : ICategoriaServicio
    {
        ...
        public async Task<bool> Editar(CategoriaDTO modelo)
        {
            try
            {
                ...
                {
                    throw new TaskCanceledException("No se encontró la categoria a editar");
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                ...
                {
                    throw new TaskCanceledException("No se encontró la categoria a eliminar");
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<CategoriaDTO> Obtener(int id)
        {
            try
            {
                ...
                if (fromDbModelo != null)
                    ...
                    throw new TaskCanceledException("No se encontró la categoria solicitada");
            }
            catch (Exception ex)
            {
                throw ex;
