    ...
    public class ProductoServicio : IProductoServicio
    {
        ...
        public async Task<bool> Editar(ProductoDTO modelo)
        {
            try
            {
                ...
                {
                    throw new TaskCanceledException("No se encontró el producto a editar");
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                ...
                {
                    throw new TaskCanceledException("No se encontró el producto a eliminar");
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<ProductoDTO> Obtener(int id)
        {
            try
            {
                ...
                if (fromDbModelo != null)
                    ...
                    throw new TaskCanceledException("No se encontró el producto solicitado");
            }
            catch (Exception ex)
            {
                throw ex;
